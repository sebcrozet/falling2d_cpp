...
namespace Falling
{
  template <typename T>
    class DoubleLinkedList
    {
      ...
      public:
        ...
        void Split(DoubleLinkedList<T>* splitnode,
                   DoubleLinkedList<T>* splitnode2);
        void Split(DoubleLinkedList<T>* splitnode,
                   DoubleLinkedList<T>* splitnode2,
                   T                    lvalue,
                   T                    rvalue);
        ...
        static DoubleLinkedList<T>* RemoveExisting(DoubleLinkedList<T>* list,
                                                   T                    val);
        void DestroyList(bool destroyValue);

        static DoubleLinkedList<T>* findExisting(DoubleLinkedList<T>* curr,
                                                 T                    val);
  ...
  template <typename T>
     void DoubleLinkedList<T>::Split(
         DoubleLinkedList<T>* splitnode,
         DoubleLinkedList<T>* splitnode2)
  {
    DoubleLinkedList<T>* n1;
    DoubleLinkedList<T>* n2;
    DoubleLinkedList<T>* s2n;
    s2n = splitnode2->next;
  ...
  template <typename T>
     void DoubleLinkedList<T>::Split(
         ...
         T                    v2)
  {
    DoubleLinkedList<T>* s1n;
    DoubleLinkedList<T>* s2n;
    DoubleLinkedList<T>* spval1;
    DoubleLinkedList<T>* spval2;
  ...
  template <typename T>
    DoubleLinkedList<T>* DoubleLinkedList<T>::RemoveExisting(
  ...
  template <typename T>
    DoubleLinkedList<T>* DoubleLinkedList<T>::findExisting(
        DoubleLinkedList<T>* curr,
        T                    val)
    {
