 ...
 */
// Generic solver using hybrid GJK-EPA collision detection/penetration depth
// calculator Compute obb-tree intersection, and then apply hybrid distance
// solver to every sub-shape
//
...
// FIXME: il ne devrait pas y avoir plus de GS_IDBIGOFFET OBB dans un arbre.
// GS_IDBIGOFFET est un nombre premier (réduction de collisions dans le pm?). 
# define GS_IDBIGOFFSET 2063
